...
public class HdfsReaderV1 extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void validate(){
            ...
            if( !specifiedFileType.equalsIgnoreCase(Constant.ORC) &&
                ...
                String message = "HdfsReader插件目前支持ORC, PAR, TEXT, CSV, SEQUENCE, RC五种格式的文件," +
                        "请将fileType选项的值配置为ORC, PAR, TEXT, CSV, SEQUENCE 或者 RC";
